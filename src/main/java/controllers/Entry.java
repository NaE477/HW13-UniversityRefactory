...
public class Entry {
    ...
    private static User auth(String username, String password) {
        ...
        ProfessorService professorService = new ProfessorService(sessionFactory, professorRep);
        StudentService studentService = new StudentService(sessionFactory, studentRep, courseService);
